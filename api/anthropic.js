 ...
 *
 * El cliente llama a /api/anthropic/v1/messages en los dos entornos:
 *   - en desarrollo lo atiende el proxy de Vite (ver vite.config.js);
 *   - en producción, un rewrite de vercel.json lo trae hasta esta función.
 *
